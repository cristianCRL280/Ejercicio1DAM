 ...
 * @author dev
 */
public class Corredor1  extends Corredores{
    
    private double MejorVuelta;
    private String NeumaticosElegidos;

    public Corredor1(double MejorVuelta, String NeumaticosElegidos, int Dorsal, String nombre, int mundiales, int vueltasRecorridas) {
