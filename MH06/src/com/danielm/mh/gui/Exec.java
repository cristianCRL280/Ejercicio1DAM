...
public class Exec {
    ...
    public static void introDinero(Scanner sc, MaquinaHelados mh) {
        String opcion = "";
        do {
    ...
    public static void comprarHelado(Scanner sc, MaquinaHelados mh) throws Exception {
        ...
        System.out.println("Vas a realizar una compra de helado ");
        System.out.print("Introduce la posición del helado que desees zamparte: ");
        opcion = sc.nextLine();
        try {
            heladoComprado = mh.pedirHelado(opcion);
            System.out.println("Recoge su helado de la máquina: " + heladoComprado);
            System.out.println("Aqui tienes su cambio. Pase un buen día " + mh.getMonedero() + "€");

        } catch (ThereIsNotEnoughMoneyException e) {
            e.printStackTrace();
